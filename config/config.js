const SCRAPE = {
  flipkart: {
    ...
    test_url:
      'https://www.flipkart.com/search?q=shoes&as=on&as-show=on&otracker=AS_Query_TrendingAutoSuggest_1_0_na_na_na&otracker1=AS_Query_TrendingAutoSuggest_1_0_na_na_na&as-pos=1&as-type=HISTORY&suggestionId=shoes&requestId=81d000a7-970a-4a0c-9ac2-798df8fb0668',
    product_url:
    ...
    product_urlspec:
      'https://www.flipkart.com/cadbury-dairy-milk-silk-fruit-nut-chocolate-bars/p/itmfykkycdgy3p5v?pid=CHCFCMT9SER8RBAV&lid=LSTCHCFCMT9SER8RBAVZUKLVB&marketplace=FLIPKART&q=chocolate&store=eat%2F0pt&srno=s_1_3&otracker=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&otracker1=AS_QueryStore_OrganicAutoSuggest_1_5_na_na_na&fm=search-autosuggest&iid=2e810c9f-3944-4ac8-9a1e-1f5581289f51.CHCFCMT9SER8RBAV.SEARCH&ppt=sp&ppn=sp&ssid=x8xqq736f40000001666685010051&qH=c378985d629e99a4',
    product_urlsel:
      'https://www.flipkart.com/cipla-tugain-solution-men-liquid/p/itm6c7fdee343bb3?pid=HSMFK65TBZQ3UFFK&lid=LSTHSMFK65TBZQ3UFFK5CXPCG&marketplace=FLIPKART&q=cipla&store=search.flipkart.com&srno=s_1_1&otracker=search&otracker1=search&fm=Search&iid=f089f96f-36d9-4a02-ae2d-f3b4c9c8937d.HSMFK65TBZQ3UFFK.SEARCH&ppt=sp&ppn=sp&ssid=kx58fke5jk0000001666767468300&qH=3d464cc1a6da11ad',
    // 'https://www.flipkart.com/wrogn-active-walking-shoes-men/p/itm3b3ad16339608?pid=SHOG2SREFZNMRYYS&lid=LSTSHOG2SREFZNMRYYSHUZDHA&marketplace=FLIPKART&q=shoes&store=osp&srno=s_1_2&otracker=AS_Query_TrendingAutoSuggest_1_0_na_na_na&otracker1=AS_Query_TrendingAutoSuggest_1_0_na_na_na&fm=search-autosuggest&iid=en_loI0ioyI3qHq04EaeBYz8lvK0z%2BSvq%2F5EQApy8znHDzbXpepmNeJ2wxSceEsUnV0gL8an6DnWM6NVSyYRcYlZg%3D%3D&ppt=sp&ppn=sp&qH=b0a8b6f820479900',

    review_url:
      'https://www.flipkart.com/cadbury-bournville-dark-chocolate-bar-fruit-nut-bars/product-reviews/itmcd163c1170d1f?pid=CHCF9F3WJ4EAEEFB&lid=LSTCHCF9F3WJ4EAEEFBRYKZKR&marketplace=FLIPKART',
    ...
    nextbtn:
      '#container > div > div > div > div > div > div > div > nav > a > span',
    // _1PEOhe
    detail: [
      {
        class: '_4ddWXP', // specification
        prod_name: 's1Q9rs',
        description: '_3Djpdu',
        mrp: '_3I9_wc',
        sale_price: '_30jeq3',
    ...
    review_link:
      '#container > div > div._2c7YLP > div > div > div > div > div > a',
    ...
    seller_since: 'sauP8h',
    FSSAI_License:
      '#container > div > div > div > div > div > div > div > div > div:nth-child(2) > span._2hpba3',
